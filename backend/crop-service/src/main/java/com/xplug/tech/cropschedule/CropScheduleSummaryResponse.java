...
@ToString
@Builder
public class CropScheduleSummaryResponse {
...
//    private CropResponse cropResponse;
    ...
    public static CropScheduleSummaryResponse of(CropSchedule cropSchedule) {
        Objects.requireNonNull(cropSchedule, "CropSchedule cannot be null!");

        return CropScheduleSummaryResponse.builder()
