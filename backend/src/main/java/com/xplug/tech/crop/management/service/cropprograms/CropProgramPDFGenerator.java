package com.xplug.tech.crop.management.service.cropprograms;
...
@Slf4j
@Service
public class CropProgramPDFGenerator {
    ...
    public CropProgramPDFGenerator(CropService cropService,
    ...
    public byte[] generateCabbageProgramPdf(Long cropId) {
        ...
        try (ByteArrayOutputStream baos = new ByteArrayOutputStream()) {
            ...
            float[] columnWidths = {1f, 1f, 1.5f, 1.5f, 1.5f, 1.5f, 1f, 1.5f}; // Adjusted widths
            ...
            for (CropStagesOfGrowth data : cropStagesOfGrowthList) {
                ...
                //age
                PdfPCell ageCell = new PdfPCell(new Phrase(String.valueOf(Period.toDays(data.getStageStartDate())), customFont));
